...
export const SkeletonWithHeight = () => <Skeleton height="40px"></Skeleton>;

export const SkeletonWithCircle = () => (
    <Skeleton circle width="40px" height="40px"></Skeleton>
);

export const SkeletonWithStyle = () => (
    <Skeleton style={{ border: "2px solid red" }} height="40px"></Skeleton>
);
